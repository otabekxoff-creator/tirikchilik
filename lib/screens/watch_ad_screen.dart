...
class _WatchAdScreenState extends State<WatchAdScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_currentAd != null) {
      ...
      reward = provider.isPremium ? widget.level.reward * 1.5 : widget.level.reward;
    }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(widget.level.icon, color: widget.level.color, size: 16),
  ...
  Widget _buildStartView(double reward) {
    return Column(
      ...
      children: [
        ...
        Text(
          'Mukofot: \$${reward.toStringAsFixed(2)}',
          style: const TextStyle(
            color: Colors.amber,
            fontSize: 20,
            fontWeight: FontWeight.bold,
  ...
  Widget _buildSuccessView(double reward) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        Text(
          'Siz \$${reward.toStringAsFixed(2)} ishlandingiz',
          style: const TextStyle(
            color: Colors.amber,
            fontSize: 24,
            fontWeight: FontWeight.bold,
